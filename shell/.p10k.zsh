# Generated by Powerlevel10k configuration wizard on 2020-11-14 at 13:28 GMT.
...
# blurred heads, flat tails, 2 lines, dotted, full frame, sparse, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%238F╰─%76F>'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%238F╰─%196F>'
